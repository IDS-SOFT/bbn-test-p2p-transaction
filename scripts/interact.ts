...
async function main() {
  ...
  const contract = await ethers.getContractFactory("P2PTransactions"); // Specify here your contract name
  ...
  const tx = await Contract.getUserBalance(userAccount); // Specify here the to-be-called function name
